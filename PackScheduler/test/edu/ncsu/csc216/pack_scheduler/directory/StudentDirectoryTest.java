...
public class StudentDirectoryTest {
	...
	public void testLoadStudentsFromFile() {
		...
		try {
			...
			x.loadStudentsFromFile("DNE.txt");
	...
	/**
	 * Gets the Student by Id within a list of students.
	 */
	@Test
	public void testGetStudentById() {
		...
		Student student2 = sd.getStudentById("daustin");
		
		assertEquals("Demetrius", student2.getFirstName());
		assertEquals(10, sd.getStudentDirectory().length);
		
		//assertThrows(IllegalArgumentException.class, 
				//() -> sd.getStudentById("spotu"));
	}
}