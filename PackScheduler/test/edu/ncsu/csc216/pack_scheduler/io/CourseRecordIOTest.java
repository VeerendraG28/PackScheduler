...
public class CourseRecordIOTest {
	...
	public void testWriteCourseRecords() {
		...
		courses.add(new Course("CSC116", "Intro to Programming - Java", "003", 3, "spbalik", CAPACITY, "MW", 1250, 1440));
		courses.add(new Course("CSC216", "Software Development Fundamentals", "001", 3, "sesmith5", CAPACITY, "MW", 1330, 1445));
		courses.add(new Course("CSC216", "Software Development Fundamentals", "601", 3, "jctetter", CAPACITY, "A"));
