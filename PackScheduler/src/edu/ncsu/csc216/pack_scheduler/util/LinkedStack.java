...
/**
 * Serves as a stack object that uses a LinkedList.
 * 
...
public class LinkedStack<E> implements Stack<E> {
	...
	/**
	 * Serves as the LinkedList of objects used in the LinkedStack.
	 */
	private LinkedAbstractList<E> list;
	
	/**
	 * Serves as the LinkedStack's constructor.
	 * @param capacity The number of objects that can 
	 */
