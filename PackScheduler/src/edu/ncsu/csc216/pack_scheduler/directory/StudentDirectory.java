...
/**
 * StudentDirectory class maintains a directory of all students enrolled at NC State, and all students have a unique id.
 * It has a SortedList of students that represent the university's student directory, and hash algorithm used to hash passwords.
 * The methods helps with updating new student directory, loading student records, adding and removing students to a list of students, and returning 
 * 2D array for developing a table for the GUI. The table will be formatted in which each row is a student and column is firstName,lastName, and id.
...
public class StudentDirectory {
	 ...
	 * @return true if the student is added, and false if the 
	 * student already exists.
	 * @throws IllegalArgumentException if the password is invalid, 
	 * if the passwords provided don't match, or if the password
	 * cannot be hashed.
	 */
	 ...
	 * @throws IllegalArgumentException if the file can't be made. 
	 */
	...
	/**
	 * The getStudentById method uses the id of a student to get a particular student.
	 * @param id the student id
	 * @return the student based on the id
	 */
